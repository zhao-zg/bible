...
public class TTSForegroundService extends Service {
    ...
    // ── Intent Actions ────────────────────────────────────────────────────
    public static final String ACTION_SPEAK    = "com.bible.tts.SPEAK";
    public static final String ACTION_STOP     = "com.bible.tts.STOP";
    public static final String ACTION_PAUSE    = "com.bible.tts.PAUSE";
    public static final String ACTION_RESUME   = "com.bible.tts.RESUME";
    public static final String ACTION_SET_RATE = "com.bible.tts.SET_RATE"; // 仅更新倍率，不重启播放
    public static final String ACTION_PRE_SPEAK = "com.bible.tts.PRE_SPEAK"; // 预合成首 chunk，加速首次播放
    public static final String ACTION_WARMUP   = "com.bible.tts.WARMUP";   // 仅启动 Service + 初始化 TTS 引擎
    ...
    // ── Constants ─────────────────────────────────────────────────────────
    private static final String CHANNEL_ID = "bible_tts_channel";
    ...
    public void onCreate() {
        ...
        ttsHandlerThread = new HandlerThread("BibleTTSWorker", android.os.Process.THREAD_PRIORITY_AUDIO);
        ...
        if (pm != null) {
            wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Bible:TTSWakeLock");
        }
        ...
        mediaSession = new MediaSession(this, "BibleTTSSession");
