...
(function() {
    ...
    var translations = {
        'zh-CN': {
            ...
            rp_mark_read: '已读',
            rp_completed: '已读 ✓',
            rp_create_record: '新增记录',
            rp_no_plan: '还没有读经计划',
            rp_select_plan: '选择下方类型开始你的读经之旅',
            rp_color_legend: '颜色说明',
            rp_confirm_delete: '确定删除此读经记录？',
            rp_morning: '清晨',
            rp_daytime: '日间',
            rp_other_time: '其他时段',
            rp_current: '当前',
            rp_completed_rounds: '已完成 {n} 遍读经',
            ...
            version_zh_rcv: '恢复本',
            version_zh_ncv: '和合本',
            version_zh_cuv: '文理和合本',
            version_en_darby: '达秘译本',
            version_en_kjv: '钦定本',
            version_he_el: '词典(来/希)',
            version_he_orig: '原文(来/希)',
            parsing_view: '原文解析',
            strongs_lookup: 'Strong\u2019s 词典',
            no_dict_entry: '暂无词典数据',
            word_analysis: '词汇分析',
            related_verses: '相关经节',
            no_analysis_data: '暂无词汇分析数据',
            no_related_verses: '未找到相关经节',
            search_results_n: '找到 {n} 处',
            current_book: '当前书卷',
            go_to_verse: '前往查看',
        ...
        'en': {
            ...
            plan_b: 'OT',
            plan_c: 'NT',
            rp_mark_read: 'Mark as Read',
            rp_completed: 'Read ✓',
            rp_create_record: 'Add Record',
            rp_no_plan: 'No reading plans yet',
            rp_select_plan: 'Select a plan type to begin',
            rp_color_legend: 'Color Legend',
            rp_confirm_delete: 'Delete this reading record?',
            rp_morning: 'Morning',
            rp_daytime: 'Daytime',
            rp_other_time: 'Other',
            rp_current: 'Current',
            rp_completed_rounds: '{n} rounds completed',
            ...
            version_zh_cuv: 'Wenli Union Version',
            version_en_darby: 'Darby Translation',
            version_en_kjv: 'King James Version',
            version_zh_ncv: 'Chinese Union Version',
            version_he_el: 'Dictionary (Heb/Gre)',
            version_he_orig: 'Original (Heb/Gre)',
            ...
            no_analysis_data: 'No word analysis data',
            no_related_verses: 'No related verses found',
            search_results_n: '{n} results found',
            ...
            fav_verse: 'Favorite Verse',
            unfav_verse: 'Unfavorite',
